...
export default function HeroSlideDecorations({
  ...
  return (
    <div className="absolute inset-0 pointer-events-none">
      ...
      <div className="lg:hidden absolute -z-10 bottom-[98px] md:bottom-[-2px] left-[calc(50%-180px)]">
        <GraphMob graph={graph} idx={idx} />
      </div>

      <div className="hidden lg:block absolute -z-10 bottom-[68px] left-[504px]">
        <GraphDesk graph={graph} idx={idx} />
      </div>

      <div className="lg:hidden absolute z-10 bottom-[-77px] right-[13px]">
        <Drops drops={drops} />
      </div>

      <div className="absolute z-10 bottom-[460px] lg:bottom-[290px] right-[24px] lg:right-[calc(50%-25px)] lg:-rotate-[83deg]">
