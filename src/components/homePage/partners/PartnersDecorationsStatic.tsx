  ...
  return (
    <div>
      ...
      <div className="absolute -z-20 top-[-5px] lg:top-[-76px] left-[calc(50%-200px)] lg:left-[166px]">
        <div className="w-[399px] lg:w-[800px] h-[286px] lg:h-[373px] rounded-full bg-black supports-[backdrop-filter]:blur-[60px] lg:supports-[backdrop-filter]:blur-[60px] will-change-transform" />
      </div>

      {/* Main blur */}
      <div className="hidden lg:block absolute -z-20 top-[-159px] left-[-425px]">
        <div className="w-[354px] h-[380px] 2xl:opacity-50 rounded-full bg-main supports-[backdrop-filter]:blur-[281px] will-change-transform" />
      </div>
    </div>
  );
}
