...
export default function ProjectCategory({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center gap-2 px-[14px] lg:px-5 py-2 lg:py-2.5 w-fit h-[29px] lg:h-[45px] rounded-full overflow-hidden bg-black/50 shadow-[inset_0px_2px_16px_rgba(255,255,255,0.25)]">
        <div
