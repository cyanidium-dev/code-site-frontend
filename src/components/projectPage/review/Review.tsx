    ...
    <section className="relative z-10 pt-30 lg:pt-[233px] bg-black">
      ...
      <Container>
        <motion.h2
          ...
          className="mb-8 font-actay flex flex-col text-[46px] font-bold leading-[110%] bg-[linear-gradient(90deg,#FF8ED2,#73C5FF)] bg-clip-text text-transparent uppercase"
        >
          {title[0]}
