    ...
    <>
      ...
      <div>
        <motion.h2
          ...
          className="hidden md:flex mb-[79px] font-actay flex-col text-[40px] font-bold leading-[110%] bg-[linear-gradient(90deg,#FF8ED2,#73C5FF)] bg-clip-text text-transparent uppercase"
        >
          {title[0]}
