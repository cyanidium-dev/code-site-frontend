  ...
  if (variant === "odd") {
    return (
      <div className="absolute inset-0 pointer-events-none">
       ...
       bg-purple-ultra-light/30 lg:bg-purple-ultra-light/70 supports-[backdrop-filter]:blur-[157px] will-change-transform rotate45 origin-center"
        />
        <div
          className="absolute -z-10 bottom-[-212px] left-[118px] lg:left-auto lg:right-[-81px] lg:bottom-[6px] w-[135px] h-[417px] rounded-full
       bg-blue-dark/20 lg:bg-blue-dark/70 supports-[backdrop-filter]:blur-[75px] will-change-transform rotate-45 origin-center"
        />
      </div>
    );
  }
